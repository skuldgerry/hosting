...
header_info() {
  clear
  cat <<"EOF"
 _____   _____   _____       ______  ______  _____    ____   _____            
|  __ \ |_   _| / ____|     |  ____||  ____||  __ \  / __ \ |  __ \     /\    
| |__) |  | |  | (___       | |__   | |__   | |  | || |  | || |__) |   /  \   
|  ___/   | |   \___ \      |  __|  |  __|  | |  | || |  | ||  _  /   / /\ \  
| |      _| |_  ____) |     | |     | |____ | |__| || |__| || | \ \  / ____ \ 
|_|     |_____||_____/      |_|     |______||_____/  \____/ |_|  \_\/_/    \_\

                     Fedora Server Post Install Script
EOF
}
...
dnf -y install fish || echo -e "${RED}Failed to install Fish shell.${RESET}"
